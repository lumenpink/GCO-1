...
<?php
    switch($paciente->RetornaDados('status')) {
        case '1': echo $LANG['reports']['evaluation']; break;
        case '2': echo $LANG['reports']['in_treatment']; break;
        case '3': echo $LANG['reports']['in_revision']; break;
        case '4': echo $LANG['reports']['closed']; break;
    }
?>
            </b>&nbsp;
          </td>
