<?php
    ...
    */
	...
	class TEspecialidades {
		...
		function ChangeEspecialidade($intCodigo) {
			$this->GetEspecContent($intCodigo);
		}
	...
	class TDentistas {
		...
		function SalvarNovo() {
			mysql_query("INSERT INTO `dentistas` (`codigo`) VALUES (null)") or die("Erro em SalvarNovo(): ".mysql_error());
	...
	class TFuncionarios {
		...
		function SalvarNovo() {
			mysql_query("INSERT INTO `funcionarios` (`codigo`) VALUES (null)") or die("Erro em SalvarNovo(): ".mysql_error());
			$this->dados['codigo'] = mysql_insert_id();
		}
